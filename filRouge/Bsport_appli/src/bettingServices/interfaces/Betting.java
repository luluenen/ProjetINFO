...
public interface Betting {
	 ...
	 */
	void AuthentificateMngr(String managerPwd) throws AuthentificationException;
	 ...
	 */
	List<List<String>> listCompetitors(String competition)
